...
public class CannonView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    // segundos subtraídos em caso de erro
    public static final int MISS_PENALTY = 2;
    // segundos adicionados em caso de acerto
    ...
    for (int n = 0; n < TARGET_PIECES; n++) {
        // Determina a velocidade aleatória entre os valores min e max para o alvo
        ...
        // aumenta a coordenada X para posicionar o próximo alvo mais a direita
    ...
    // alinha o cano e dispara uma bala caso ainda não haja uma na tela
    ...
    private void showGameOverDialog(int messageId) {
        ...
        builder.setCancelable(false);  // Caixa de diálogo modal
        ...
        builder.setPositiveButton(R.string.reset_game,
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) { // chamado quando o botão "Reset Game" é pressionado
    ...
    public void drawGameElements(Canvas canvas) {
        ...
        canvas.drawText(getResources().getString(
                R.string.tempo_restante_formatado, timeLeft), 50, 100, textPaint);
    ...
    // verifica se abala colide com a barreira ou qualquer um dos alvos e trata essas colisões
    public void testForCollisions() {
        // remove quaisquer alvos em que a bala colide (testa se a bala está na tela)
        if (cannon.getCannonball() != null &&
                cannon.getCannonball().isOnScreen()) {
